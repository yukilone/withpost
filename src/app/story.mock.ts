...
export const STORIES: Story[] = [
  ...
  { id: 6, state: "inactive", title: "맛있는 요리 레시피 2탄", desc: "Someone famous in Source Title", content: "Enim labore aliqua consequat ut quis ad occaecat aliquip incididunt. Sunt nulla eu enim irure enim nostrud aliqua consectetur ad consectetur sunt ullamco officia. Ex officia laborum et consequat duis.", imgUrl: "/assets/img/6.jpg" },
  {
    ...
    <br><br>
    처음에는 다들 담담하게 시작한다. 이 정도면 할만 하겠다는 표정으로.<br><br>
    고추를 다 먹으면, 남은 꼭지를 들어올려서 이번 라운드를 잘 마쳤다는 것을 보여주면 된다. 아직까지는 다들 표정이 괜찮다.<br>
    라운드가 올라갈수록 조금씩 사람들의 표정이 심각해지기 시작한다.<br>
    그리고 첫 기권자 발생. 매운 맛을 견디지 못하고 우유를 들이키면 기권 처리된다. 아쉽게도 이번 대회의 첫 기권은 아시아 여성이었다. <br>
    기권자는 점점 늘어나고...<br>
    10라운드에 이르자 이제는 무시무시한 통각을 버티는 사람들이 더 많아졌다.<br>
    15라운드까지 남은 사람은 단 두 명.<br>
    마지막까지 잘 살아남자며 서로 울면서 악수도 나눴지만...<br>
    하쿤 키밍가(Hakun Kimminga)씨는 결국 마지막 라운드에서 포기를 선언하고, 눈 앞에 있는 우유를 벌컥벌컥 마셨다. 이번 대회의 우승은 시드 바버(Sid Barber)씨에게로.<br><br>
    <iframe width="100%" height="420" src="https://www.youtube.com/embed/C-Opm9b2WDk" frameborder="0" allowfullscreen></iframe>
    <br><br>
    상금 때문에 이렇게나 매운 고추를 먹는 건가 싶겠지만, 우승자가 받는 상금은 50파운드(한화로 85,000원 남짓)에 지나지 않는다. 결국 모두 재미로 하는 일.<br>
    행사를 요약한 영상은 여기서 확인할 수 있다.<br>
    이와 같은 고추 행사들은 영국 내 고추 소비 진작과 관련 업계 진흥을 목적으로 꾸려지고 있다고 한다. 어떻게든 더 매운 맛을 먹고 견뎌내보려는 사람들의 심리는 뭘까 싶으면서도, 이들이 느낄 짜릿함이 이해되지 않는 것은 아니다. (왠지 오늘 밤 불닭**면을 먹게 될 것 같은 느낌적 느낌이...) 매운 음식을 좋아하는 주변 사람들과 이 핫한 사진들을 공유해보자. 물론 지나친 캡사이신 섭취는 몸에 해롭다는 말과 함께.<br>
